  ...
  return (
    <div className="p-4">
      ...
      <ul className="list-disc list-inside">
        <li><Link to="/articles/mcp-inspector-tools-guide" className="text-blue-500">A Developer's Guide to MCP Inspector Tools</Link></li>
        <li><Link to="/articles/about-this-site" className="text-blue-500">About This Site: The Online MCP Inspector</Link></li>

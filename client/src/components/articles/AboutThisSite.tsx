...
const AboutThisSite: React.FC = () => {
  return (
    <div className="p-4 max-w-4xl mx-auto">
      <h1 className="text-3xl font-bold mb-4">About This Site: The Online MCP Inspector</h1>
      <p className="text-sm text-muted-foreground mb-6">Published on June 26, 2025</p>

      <p className="mb-4">Welcome to the Online MCP Inspector, a developer tool designed for testing and debugging MCP (Model Context Protocol) servers. This project is a fork of the official <strong>@modelcontextprotocol/inspector</strong>, adapted to provide a seamless, web-first experience.</p>
